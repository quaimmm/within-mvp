...
export function NetworkStatus({ address, chainId, mock = false, confirmed = false, onClick }: { address?: string | null; chainId?: string | null; mock?: boolean; confirmed?: boolean; onClick?: () => void }) {
  const label = mock ? "Demo mode · Mock settlement" : confirmed ? "Arc Testnet · Settlement confirmed" : !address ? "Arc Testnet · Wallet not connected" : isArcTestnet(chainId) ? "Arc Testnet · Connected" : "Arc Testnet · Wrong network";
